...
### Aim
To implement Bubble Sort, Selection Sort, Insertion Sort, Merge Sort and Quick Sort in C++ and analyze their time and space complexities.
...
### Output
```text
Bubble Sort: 3 11 12 22 25 34 45 64 78 90
Selection Sort: 3 11 12 22 25 34 45 64 78 90
Insertion Sort: 3 11 12 22 25 34 45 64 78 90
Merge Sort: 3 11 12 22 25 34 45 64 78 90
Quick Sort: 3 11 12 22 25 34 45 64 78 90
```

### Time and Space Complexity
Bubble: Best Θ(n), Average/Worst Θ(n²), Space Θ(1). Selection: Θ(n²) for all cases, Space Θ(1). Insertion: Best Θ(n), Average/Worst Θ(n²), Space Θ(1). Merge: Θ(n log n) for all cases, Space Θ(n). Quick: Best/Average Θ(n log n), Worst Θ(n²).

### Result
The practical was implemented successfully and the required output was obtained.
